...
'''the relative size of the transformation should be calculated in pixels if possible to ensure that it does not conflict with syntehtic.py'''
...
# Deselect all objects & Delete the cube that is autogenerated in Blender
